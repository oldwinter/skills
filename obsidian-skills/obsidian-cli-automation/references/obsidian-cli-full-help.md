# Obsidian CLI Full Help Traversal

- Source command: `obsidian --help` + `obsidian help <command>` for every discovered command
- Discovered commands: 98
- Traversal date: 2026-02-19
