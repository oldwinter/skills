...
Two layers. Category buckets are the classification source of truth; 43 root directories are also installable skill names. Six names exist in both layers and may diverge (`find-skills` already does). See `README.md` Standalone Skills.

```
skills/
├── AGENTS.md
├── README.md
├── <43 root skill directories>
...
`just audit-readme` verifies the handwritten README map against this tree.
