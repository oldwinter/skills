# mdbase — Typed Markdown Collections (Gemini Code Assist)

> This is a self-contained adapter for Gemini Code Assist. For native Agent Skills support in other tools, see the main repository.
