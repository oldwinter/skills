# mdbase — Typed Markdown Collections (Aider)

> This is a self-contained adapter for Aider. For native Agent Skills support in other tools, see the main repository.
